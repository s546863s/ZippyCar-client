...
const GoogleLogin = ({ buttonText = "Continue with Google" }) => {
  ...
  const initializeGoogleSignIn = () => {
    ...
    // Render the button using Google's built-in button
  ...
  useEffect(() => {
    // Load Google API script only once

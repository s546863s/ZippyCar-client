        ...
        >
          {dummyCars.map((car) => (
            <motion.div 
              ...
              whileHover={{ y: -8 }}
              className="bg-[#111827] border border-slate-800 hover:border-amber-500/40 rounded-2xl overflow-hidden transition-all duration-300 group flex flex-col shadow-xl"
            >
              <div className="relative h-48 w-full bg-slate-900 overflow-hidden">
                ...
                />
                {/* Fixed: backdrop-blur-sm (v3 standard) instead of backdrop-blur-xs */}
                <span className="absolute top-4 right-4 bg-slate-900/90 backdrop-blur-sm border border-slate-700 text-xs font-bold px-3 py-1 rounded-lg text-amber-500 flex items-center gap-1 select-none">
                  ★ {car.rating}
                </span>
              </div>
